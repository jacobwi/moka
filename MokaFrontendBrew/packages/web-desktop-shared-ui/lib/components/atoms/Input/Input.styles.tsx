export const inputStyles = {
  ...
  props: {
    variant: {
      classic:
        "border rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500",
      underline:
        "border-0 border-b-2 border-gray-300 focus:border-blue-500 focus:ring-blue-500",
      floating:
        "border-0 border-b-2 border-gray-300 bg-transparent focus:border-blue-500 focus:ring-blue-500",
      ...
      neumorphic:
        "bg-gray-50 rounded-lg shadow-sm focus:shadow-md focus:border-gray-400",
    },
    state: {
      default: "",
      success: "border-green-500 focus:border-green-600 focus:ring-green-500",
      error:
        "border-red-500 focus:border-red-600 focus:ring-red-500 text-red-600 placeholder-red-400",
    },
    size: {
