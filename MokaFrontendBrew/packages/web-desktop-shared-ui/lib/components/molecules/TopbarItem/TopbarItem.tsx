...
import { topbarStyles, TopbarItemVariant } from '../../organisms/Topbar/Topbar.styles';
...
const SidebarItem: React.FC<TopbarItemProps> = ({ icon: Icon, label, variant = 'default', onClick }) => {
