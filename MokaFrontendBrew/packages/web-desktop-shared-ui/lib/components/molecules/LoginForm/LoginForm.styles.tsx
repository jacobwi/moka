export const loginFormStyles = {
  ...
  submitButton:
    "w-full mt-8 py-3 text-white bg-black hover:bg-gray-800 rounded-lg font-medium shadow transition-colors duration-300 ease-in-out",
  rememberMe: "flex items-center mt-4", // Style for the Remember Me checkbox
  forgotPassword:
    "text-sm text-blue-600 hover:text-blue-800 cursor-pointer mt-4", // Style for the Forgot Password link
  variants: {
    default: "max-w-md",
    ...
    withImage: {
      ...
      imageSection:
        "hidden md:block w-full md:w-1/2 bg-cover bg-center bg-no-repeat rounded-l-xl",
      content: "flex-1 rounded-r-xl p-8",
    },
    withLogo: "max-w-md mb-6",

    inline:
      "flex items-center justify-between max-w-lg p-4 bg-white rounded-lg shadow",
  },
