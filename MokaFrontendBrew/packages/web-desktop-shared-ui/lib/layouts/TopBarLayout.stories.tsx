...
const topbarProps: TopbarProps = {
    items: [
        ...
        { icon: FiSettings, label: 'Settings', onClick: () => console.log('Settings clicked') },
        { icon: FiUser, label: 'Profile', onClick: () => console.log('Profile clicked') },
    ],
    showAvatar: true,
    ...
    args: {
        ...
        children: (
            <div>
                ...
                <p>This is the main content area below the top bar. Add more content or components here.</p>
            </div>
        ),
    },
};
...
export const WithoutAvatar: StoryObj<typeof TopBarLayout> = {
    args: {
        ...
        children: (
            <div>
                <h1 className="text-2xl font-bold mb-4">Main Content Area</h1>
                <p>This variant of the layout does not include an avatar in the top bar.</p>
            </div>
        ),
    },
};