...
function extractDynamicPropOptions(styles) {
  ...
  return Object.entries(props).reduce(function (acc, _a) {
    var key = _a[0],
      value = _a[1];
    if (isObject(value)) {
      var optionKeys = Object.keys(value).filter(function (subKey) {
        return typeof value[subKey] === "string";
      });
...
function generateDynamicArgTypes(options) {
  return Object.keys(options).reduce(function (acc, key) {
    ...
    if (
      typeof (metadata === null || metadata === void 0
        ? void 0
    ...
    // Check if metadata.control is an object with a 'type' property
      ...
      (metadata === null || metadata === void 0 ? void 0 : metadata.control) &&
      "type" in metadata.control
    ) {
    ...
    if (key.includes(".")) {
      ...
      if (propMetadata[parentKey]) {
        category =
          (_a = propMetadata[parentKey].category) !== null && _a !== void 0
            ? _a
            : "Other";
      }
    }
    ...
    acc[key] = {
      ...
      description:
        (metadata === null || metadata === void 0
          ? void 0
          : metadata.description) || "Styles for ".concat(key),
      defaultValue:
        metadata === null || metadata === void 0
          ? void 0
