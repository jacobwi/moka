...
export function co(baseClasses, _a) {
    var variants = _a.variants, defaultVariants = _a.defaultVariants;
    return function (variantProps) {
        ...
        Object.keys(variants).forEach(function (key) {
            ...
            var variantClass = propValue
                ? (_a = variants[propKey]) === null || _a === void 0 ? void 0 : _a[String(propValue)]
                : (_b = variants[propKey]) === null || _b === void 0 ? void 0 : _b[defaultVariants[propKey]];
            if (variantClass) {
