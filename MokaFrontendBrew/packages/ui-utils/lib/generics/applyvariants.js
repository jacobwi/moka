...
export function av(baseObject, variantsConfig, variantProps) {
    return Object.entries(variantProps).reduce(function (result, _a) {
        ...
        var variantFunction = (_b = variantsConfig[prop]) === null || _b === void 0 ? void 0 : _b[variantValue];
        ...
        if (typeof variantFunction === 'function') {
            ...
            console.warn("Variant function for prop \"".concat(prop, "\" with value \"").concat(variantValue, "\" not found."));
            return result;
        }
    }, baseObject);
}
